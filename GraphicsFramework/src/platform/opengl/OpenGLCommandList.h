...
public:
	...
	void SetVertexBufferDataStatic(const void* data, unsigned int size, unsigned int usage = GL_MAP_READ_BIT);
	void SetIndexBufferDataStatic(const void* data, unsigned int size, unsigned int usage = GL_MAP_READ_BIT);
